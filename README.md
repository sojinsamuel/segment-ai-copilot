...
<p align="center">
  An open-source AI chatbot app with baked in observability template built with Next.js, the Vercel AI SDK, OpenAI, Vercel KV and Twilio Segment.
</p>
...
Remember to update the segment write key in your environment `.env` file (`NEXT_PUBLIC_SEGMENT_WRITE_KEY`) file with the write key to your node.js Segment source.
